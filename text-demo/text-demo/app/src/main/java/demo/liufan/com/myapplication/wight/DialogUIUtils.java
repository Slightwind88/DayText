...
import demo.liufan.com.myapplication.listener.DialogAssigner;
import demo.liufan.com.myapplication.listener.DialogUIItemListener;
...
//    }
     ...
     * @param listener         事件监听
     */
    public static BuildBean showAlert(Activity activity, CharSequence title, CharSequence msg, CharSequence hint1,
        ...
        return DialogAssigner.getInstance().assignAlert(activity, title, msg, hint1, firstTxt, secondTxt, isVertical, cancleable, outsideTouchable, listener);
    }
